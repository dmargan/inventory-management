      ...
      <div className="flex justify-between items-center gap-5">
        <div className="hidden md:flex justify-between items-center gap-5">
          ...
          <div className="relative">
            ...
            justify-center px-[0.4rem] py-1 text-xs font-semibold leading-none text-red-100
          ...
          <div className="flex items-center gap-3 cursor-pointer">
            <Image
              src="https://s3-marcom.s3.eu-central-1.amazonaws.com/profile.jpg"
              alt="Profile image"
              width={50}
              height={50}
              className="rounded-full h-full object-cover"
            />
            <span className="font-semibold">Davor Margan</span>
          </div>
        </div>
        <Link href="/settings">
